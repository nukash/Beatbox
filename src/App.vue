...
export default {
  ...
  data: () => ({
    ...
    bgmList: [
      ...
      {
        id: 2,
        url: "./audio/bgm/02/sunday-afternoon.mp3.mp3",
      },
      {
        id: 3,
      ...
      {
        id: 5,
        url: "./audio/bgm/05/natsu-is-summer!!.mp3.mp3",
      },
      {
        id: 6,
        url: "./audio/bgm/06/Fickle.mp3.mp3",
      },
      {
        id: 7,
        url: "./audio/bgm/07/party.mp3.mp3",
      },
      {
        id: 8,
        url: "./audio/bgm/08/Dies_irae.mp3.mp3",
      },
      {
        id: 9,
